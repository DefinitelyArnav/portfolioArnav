...
```
This blog post covers plotting spatial points and visualising spatial data on in R. We will be covering the concepts of shapefiles, GeoJSON, Leaflets and sp objects and to how to read and manipulate them in R. At the end you would have created the following three interactive spatial maps:
